...
// Verifica se a seção 'codcli' está definida
...
// Agora você pode usar $_SESSION['codcli'] para obter o código do cliente
$codcli = $_SESSION['codcli'];

// Restante do seu código para a página pga1.php
?>
...
<body background="img/planodefundo1.webp">
    <header>
        <nav class="nav-bar">
            ...
            <div class="nav-list">
                <ul>
                <li class="nav-item"><a href="servicocliente.php" class="nav-link">Tabela de serviços</a></li>
                    <li class="nav-item"><a href="http://localhost/barbearia/agendamentos.php" class="nav-link">Agendamento</a></li>
                    <li class="nav-item"><a href="http://localhost/barbearia/verhorarios.php" class="nav-link">consultar horarios disponiveis</a></li>
        ...
        <div class="mobile-menu">
            <ul>
            <li class="nav-item"><a href="servicocliente.php" class="nav-link">Tabela de serviços</a></li>
                <li class="nav-item"><a href="http://localhost/barbearia/caminho_agenda.php" class="nav-link">Agendamento</a></li>
                <li class="nav-item"><a href="http://localhost/barbearia/verhorarios.php" class="nav-link">consultar horarios disponiveis</a></li>
...
<footer>
    ...
    <ul class="footer-list">
        ...
        <li>
            <a>Abertos segunda a sexta independente de ser feriado</a>
        </li>
    </ul>
  </div>
