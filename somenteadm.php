...
<body background="img/planodefundo1.webp">
    <header>
        <nav class="nav-bar">
            ...
            <div class="nav-list">
                <ul>
                    <li class="nav-item"><a href="teste.php" class="nav-link">clientes</a></li>
                    <li class="nav-item"><a href="testefunc.php" class="nav-link">funcionarios</a></li>
                    <li class="nav-item"><a href="servicos.php" class="nav-link">Serviços</a></li>
                    <li class="nav-item"><a href="caminho_agenda.php" class="nav-link">Agendamentos</a></li>
                    <li class="nav-item"><a href="cidade.php" class="nav-link">Cidades</a></li>
                </ul>
            </div>
        ...
        <div class="mobile-menu">
            <ul>
                <li class="nav-item"><a href="#" class="nav-link">funcionarios</a></li>
                <li class="nav-item"><a href="crudd.html" class="nav-link">clientes</a></li>
                <li class="nav-item"><a href="servicos.php" class="nav-link">Serviços</a></li>
                <li class="nav-item"><a href="age.adm.php" class="nav-link">Agendamentos</a></li>
                <li class="nav-item"><a href="cidade.php" class="nav-link">Cidades</a></li>
            </ul>
